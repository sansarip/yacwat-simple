(defproject yacwat-simple "0.1.0-SNAPSHOT"
  ...
  {:dev     {:dependencies [[binaryage/devtools "0.9.10"]
   ...
   :uberjar {:source-paths       ["env/prod/clj"]
             ...
             :omit-source        true
             :main               yacwat-simple.server
             :aot                [yacwat-simple.server]
             :uberjar-name       "yacwat-simple.jar"
             :prep-tasks         ["compile" ["fig:prod"]]
             :uberjar-exclusions [#"devcards\.html"]}}
  :ring {:handler yacwat-simple.handler/app})
